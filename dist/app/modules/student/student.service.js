...
const deleteStudent = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const ifExist = yield student_model_1.Student.findOne({ id });
    if (!ifExist) {
    ...
    try {
        ...
        // Delete user
        const userResult = yield user_model_1.User.findOneAndDelete({ id }, { session });
        if (!userResult) {
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Failed to delete user');
        }
        // Delete student
        const studentResult = yield student_model_1.Student.findOneAndDelete({ id }, { session });
        if (!studentResult) {
            throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Failed to student');
        }
