...
// Pre Hook => When apply hook before save
...
academicSemesterSchema.pre('save', function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        if (Number(this.year) < 2000) {
            throw new ApiError_1.default(http_status_1.default.CONFLICT, 'Year must be greater than or equal to 2000');
        }
        next();
    });
});
academicSemesterSchema.pre('save', function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (isExist) {
            throw new ApiError_1.default(http_status_1.default.CONFLICT, 'Academy semester type and year are already exists!');
        }
        next();
    });
});
